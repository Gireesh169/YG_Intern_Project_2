  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-rose-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">We couldn't process your transaction</p>

        <div className="bg-gray-100 rounded-lg p-4 mb-6 text-left space-y-3">
          <div className="flex justify-between">
            <span className="text-gray-500">Error Reason</span>
            <span className="font-semibold text-red-600">{errorDetails.reason}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-500">Card Used</span>
            <span className="font-semibold">**** **** **** {errorDetails.cardLastFour}</span>
          </div>
          <div className="flex justify-between">
